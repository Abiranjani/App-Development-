    ...
    return (
      ...
      <div class="about-me">
        ...
        <img style={{height:"100px",width:"110px"}} src="https://cdn-icons-png.flaticon.com/512/2266/2266182.png" alt="easyclass" /><br></br>
          ...
          <p>Your Bank offers a wide range of loans to meet your diverse needs. Whether the need is for a house, child's education, our unique and need specific loans will enable you to convert your dreams to realities.</p>
        </div>
      ...
      <Box sx={{ flexGrow: 1 }} >
        ...
        <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1 }}style={{backgroundColor:" #45b39d "}}>
          <Toolbar>
            ...
            <Button color="inherit">{ store.getState().user.name    }</Button>
